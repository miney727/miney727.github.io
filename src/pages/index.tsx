            ...
            <Container>
                ...
                <div className="flex flex-col justify-between md:flex-row gap-y-4 md:gap-y-0">
                    ...
                    <div className="flex flex-row ">
                        ...
                        <div className="flex flex-col w-fit gap-y-4 md:gap-y-4">
                            <p className="text-sm md:text-base ">병역필</p>
                            ...
                            imgComponent={
                                ...
                                >
                                    {imgUtils.toondra_imgs.map(image => {
                                        return (
                                            <img src={image} className="border border-black-m w-[48%]" />
                                        )
                                    })}
                                </ScrollContainer>
                            }
            ...
            <Container>
                ...
                <Company title="교육">
                    <SimpleProjectCard
                        ...
                        title="중앙대학교 컴퓨터공학과"
                        description={"증잉대학교 컴퓨터공학과 학사 졸업.\nGPA: 3.4/4.5"}
                    />
                </Company>
                <Margin margin={40} />
                <Company title="자격">
